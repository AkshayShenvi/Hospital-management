...
{
    public partial class FitnessDetails : Form
    {
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                FitnessCertificateReportViewer fitnessCirtificateReport = new FitnessCertificateReportViewer(cd);
                fitnessCirtificateReport.ShowDialog();
                this.Close();
            }
            catch(Exception ex)
            { }
        ...
        private void FitnessDetails_Load(object sender, EventArgs e)
        {
